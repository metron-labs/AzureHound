...
// ChromeOSInfo represents Chrome OS device information with proper type safety
type ChromeOSInfo struct {
	...
	LastPolicySync       time.Time `json:"lastPolicySync"`
...
type IntuneDevice struct {
	...
	// Fixed: Use proper struct type instead of []interface{}
	ChromeOSDeviceInfo                      []ChromeOSInfo `json:"chromeOSDeviceInfo"`
